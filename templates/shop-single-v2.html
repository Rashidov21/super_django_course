...
<body>
    ...
    <!-- /header -->
    <section class="shop-single-page-v2">
        <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="shop-single-item-img">
                            <div class="main-img">
                                <div class="main-img-item">
                                    <a href="#"><img src="img/products/hoddie.jpg" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="main-img-item">
                                    <a href="#"><img src="img/products/hoddie_1.jpg" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="main-img-item">
                                    <a href="#"><img src="img/products/hoddie_2.jpg" alt="images" class="img-responsive"></a>
                                </div>
                                <div class="main-img-item">
                                    <a href="#"><img src="img/products/hoddie_3.jpg" alt="images" class="img-responsive"></a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-7">
                        <div class="shop-sing-item-detail">
                            <h3><a href="#">MEN’S HALF DOME HOODIE</a></h3>
                            <div class="brandname">by <strong>TNF</strong></div>
                            ...
                            <div class="product-option">
                                ...
                                <label>Color:</label>
                                <ul class="color">
                                    <li><a href="#"><img src="img/product/color-img-1.jpg" alt="images" class="img-responsive"></a></li>
                                    <li><a href="#"><img src="img/product/color-img-2.jpg" alt="images" class="img-responsive"></a></li>
                                    <li><a href="#"><img src="img/product/color-img-3.jpg" alt="images" class="img-responsive"></a></li>
                                    <li><a href="#"><img src="img/product/color-img-4.jpg" alt="images" class="img-responsive"></a></li>
                                    <li><a href="#"><img src="img/product/color-img-5.jpg" alt="images" class="img-responsive"></a></li>
                                </ul>
                                <div class="clearfix"></div>
                            </div>
